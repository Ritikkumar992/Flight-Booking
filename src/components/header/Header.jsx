...
import {faBed,faPlane,faTaxi,faCar,faPerson,faCalendarDays} from "@fortawesome/free-solid-svg-icons";
import "./header.css";
        ...
        { type != "list" &&
          <>
            ...
            <p className="headerDesc">
              Get rewarded for your traverls - unlock instant savings of 10% or
              more with a FlightBooking account.
            </p>
